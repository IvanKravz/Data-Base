...
class Employee(models.Model):
    ...
    contract_date = models.DateField(verbose_name='Дата контракта', null=True)
    form_state_secrets = models.CharField(max_length=15, verbose_name='Форма гостайны', null=True)
    number_state_secrets = models.CharField(max_length=15, verbose_name='Номер допуска', null=True)
    data_state_secrets = models.DateField(verbose_name='Дата допуска', null=True)
    education = models.CharField(max_length=50, verbose_name='Уровень образования', null=True)
    institution = models.CharField(max_length=100, verbose_name='Учебное заведение', null=True)
    year_graduation = models.DateField(verbose_name='Дата окончания учебного заведения', null=True)
    date_start_work = models.DateField(verbose_name='Дата начала службы', null=True)
    date_end_work = models.DateField(verbose_name='Дата окончания контракта', null=True)
    description = models.TextField(verbose_name='Комментарии', null=True)
