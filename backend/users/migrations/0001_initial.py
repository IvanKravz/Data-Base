    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_material_responsible', models.BooleanField(default=False, verbose_name='Материально ответственное лицо')),
                ('is_sha_worker', models.BooleanField(default=False, verbose_name='ШаРаботник')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='users', to='facilities.division', verbose_name='Подразделение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='sha_details', to='users.user', verbose_name='Пользователь')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('sha_details', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='equipment', to='users.shaworkerdetails', verbose_name='ШаРаботник')),
            ],
            options={
