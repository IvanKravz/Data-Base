...
export function CreateClosedFacilityPage() {
    ...
    <div className="max-w-4xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate('/facilities-closed')}
            className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
          >
            <ArrowLeft className="h-5 w-5" />
          </button>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Добавление закрытого объекта</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        <FacilityForm
          ...
          onCancel={() => navigate('/facilities-closed')}
          isClosedFacility={true}
        />
      </div>
    </div>
  );
