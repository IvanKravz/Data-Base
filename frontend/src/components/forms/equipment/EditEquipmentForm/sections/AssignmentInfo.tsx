...
import { samplePersonnel, sampleFacilities } from '../../../../../data/sampleData';
...
export function AssignmentInfo({ formData, onChange }: AssignmentInfoProps) {
  ...
  const divisionFacilities = sampleFacilities.filter(
    facility => facility.division === formData.division &&
    (!formData.subdivision || facility.subdivision === formData.subdivision)
  );
